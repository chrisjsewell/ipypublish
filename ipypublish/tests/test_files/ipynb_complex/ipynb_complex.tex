...
\begin{document}
    ...
    \begin{titlepage}
  \begin{flushright}
    \includegraphics[width=0.7\textwidth]{ipynb_complex_files/logo_example.png}
  \end{flushright}
...
\section{Images and Figures}\label{images-and-figures}}
    ...
    \begin{figure}[!bh]\begin{center}\adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{ipynb_complex_files/output_13_0.jpeg}\end{center}\caption{A nice picture.}\label{fig:example}\end{figure}
...
\begin{figure}\begin{center}\adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{ipynb_complex_files/output_17_0.pdf}\end{center}\caption{A matplotlib figure, with the caption set in the markdowncell above the
...
\bibliography{ipynb_complex_files/example}
