...
% latex-tplx
% define segments to insert into the the template jinja template of id latex-tplx
% with segments:
...
% - standard-standard_article: with standard nbconvert article setup
% - standard-standard_contents: with standard nbconvert input/output content
% - standard-in_out_prompts: with in/out prompts
%
%%%%%%%%%%%% DOCCLASS
