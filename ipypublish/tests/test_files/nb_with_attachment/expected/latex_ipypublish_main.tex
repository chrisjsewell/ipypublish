...
\hypertarget{notebook-with-attachment}{%
\section{Notebook with attachment}\label{notebook-with-attachment}}

\begin{figure}[]
\begin{center}
\adjustimage{max size={0.9\linewidth}{0.9\paperheight},}{main_files/attach_1_output_13_0.jpeg}
\end{center}
\caption{output\_13\_0.jpeg}
\end{figure}
