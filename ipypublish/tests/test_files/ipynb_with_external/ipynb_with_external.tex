...
\section{Images and Figures}\label{images-and-figures}}
    ...
    \begin{figure}[!bh]\begin{center}\adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{ipynb_with_external_files/output_13_0.jpeg}\end{center}\caption{A nice picture.}\label{fig:example}\end{figure}
