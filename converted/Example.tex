...
\section{Images and Figures}\label{images-and-figures}
    ...
    \begin{figure}[!bh]
        \begin{center}\adjustimage{max size={0.9\linewidth}{0.4\paperheight}}{Example_files/output_9_0.jpeg}\end{center}\caption{A nice picture.}
        \label{fig:example}
    \end{figure}

    \begin{figure}
        \begin{center}\adjustimage{max size={0.9\linewidth}{0.4\paperheight}}{Example_files/output_10_0.png}\end{center}\caption{Horizontally aligned images.}
        \label{fig:example_h}
    \end{figure}

    \begin{figure}
        \begin{center}\adjustimage{max size={0.9\linewidth}{0.4\paperheight}}{Example_files/output_11_0.png}\end{center}\caption{Vertically aligned images.}
        \label{fig:example_v}
    \end{figure}

    \begin{figure}
        \begin{center}\adjustimage{max size={0.9\linewidth}{0.4\paperheight}}{Example_files/output_12_0.png}\end{center}\caption{Images aligned in a grid.}
...
\begin{figure}
        \begin{center}\adjustimage{max size={0.9\linewidth}{0.4\paperheight}}{Example_files/output_16_0.pdf}\end{center}\caption{A matplotlib figure, with the caption set in the markdowncell above the figure.}
...
\section{Tables (with pandas)}\label{tables-with-pandas}
    ...
    \begin{table}[H]\caption{An example of a table created with pandas dataframe.}
