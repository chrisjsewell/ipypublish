...
\todo{test}\begin{lstlisting}[backgroundcolor=\color{blue!10},language=Tex,numbers=none,xrightmargin=5pt,belowskip=2pt,aboveskip=2pt,]
...
\section{Images and Figures}\label{images-and-figures}
    ...
    \begin{figure}[!bh]
        \begin{center}\adjustimage{max size={0.9\linewidth}{0.4\paperheight}}{Example_files/output_11_0.jpeg}\end{center}\caption{A nice picture.}\label{fig:example}
    \end{figure}

    \begin{figure}
        \begin{center}\adjustimage{max size={0.9\linewidth}{0.4\paperheight}}{Example_files/output_12_0.png}\end{center}\caption{Horizontally aligned images.}\label{fig:example_h}
    \end{figure}

    \begin{figure}
        \begin{center}\adjustimage{max size={0.9\linewidth}{0.4\paperheight}}{Example_files/output_13_0.png}\end{center}\caption{Vertically aligned images.}\label{fig:example_v}
    \end{figure}

    \begin{figure}
        \begin{center}\adjustimage{max size={0.9\linewidth}{0.4\paperheight}}{Example_files/output_14_0.png}\end{center}\caption{Images aligned in a grid.}\label{fig:example_grid}
    \end{figure}

\subsection{Displaying a plot with its
code}\label{displaying-a-plot-with-its-code}

\todo{test}\begin{codecell}
...
\begin{figure}
        \begin{center}\adjustimage{max size={0.9\linewidth}{0.4\paperheight}}{Example_files/output_18_0.pdf}\end{center}\caption{A matplotlib figure, with the caption set in the markdowncell above the figure.}\label{fig:example_mpl}
    \end{figure}

\section{Tables (with pandas)}\label{tables-with-pandas}

\todo{test}\begin{codecell}[H]
...
\section{Embedded HTML}\label{embedded-html}

HTML was created using
\href{https://ipyvolume.readthedocs.io}{ipyvolume}, and will render
below in .html type outputs:

% sort citations by order of first appearance
\bibliographystyle{unsrtnat}
\bibliography{Example_files/example.bib}
