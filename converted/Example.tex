...
\Crefname{codecell}{code}{codes}
	...
	\begin{document}
		...
		\begin{titlepage}
	\begin{flushright}
		\includegraphics[width=0.7\textwidth]{/Users/cjs14/GitHub/ipypublish/example/logos/logo_example.png}
	\end{flushright}
...
\section{Images and Figures}\label{images-and-figures}
    ...
    \begin{figure}[!bh]
        \begin{center}\adjustimage{max size={0.9\linewidth}{0.4\paperheight}}{Example_files/output_9_0.jpeg}\end{center}

		\ifdefined\kyfigcexample
		 \caption{\kyfigcexample}
		\else
    ...
    \begin{figure}
        \begin{center}\adjustimage{max size={0.9\linewidth}{0.4\paperheight}}{Example_files/output_10_0.png}\end{center}

		\ifdefined\kyfigcexampleuh
		 \caption{\kyfigcexampleuh}
		\else
    ...
    \begin{figure}
        \begin{center}\adjustimage{max size={0.9\linewidth}{0.4\paperheight}}{Example_files/output_11_0.png}\end{center}

		\ifdefined\kyfigcexampleuv
		 \caption{\kyfigcexampleuv}
		\else
    ...
    \begin{figure}
        \begin{center}\adjustimage{max size={0.9\linewidth}{0.4\paperheight}}{Example_files/output_12_0.png}\end{center}

		\ifdefined\kyfigcexampleugrid
		 \caption{\kyfigcexampleugrid}
		\else
...
\begin{figure}
        \begin{center}\adjustimage{max size={0.9\linewidth}{0.4\paperheight}}{Example_files/output_16_0.pdf}\end{center}
...
\bibliography{/Users/cjs14/GitHub/ipypublish/example/bibliographies/example.bib}
