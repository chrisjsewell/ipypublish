...
\Crefname{codecell}{code}{codes}
	...
	\begin{document}
		...
		\begin{titlepage}\begin{flushright}
		\includegraphics[width=0.7\textwidth]{logo_example}
	\end{flushright}
...
\section{Images and Figures}\label{images-and-figures}
    ...
    \begin{figure}[!bh]
        \begin{center}\adjustimage{max size={0.9\linewidth}{0.4\paperheight}}{Example_files/Example_9_0.jpeg}\end{center}
